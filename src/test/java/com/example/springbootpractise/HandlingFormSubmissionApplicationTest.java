...
import com.example.springbootpractise.submission.GreetingSubmissionController;
...
@WebMvcTest(GreetingSubmissionController.class)
...
public class HandlingFormSubmissionApplicationTest {
	...
	public void rendersForm() throws Exception {
		mockMvc.perform(get("/submission/greeting"))
				.andExpect(content().string(containsString("Form")));
	}

	@Test
	public void submitsForm() throws Exception {
		mockMvc.perform(post("/submission/greeting").param("id", "12345").param("content", "Hello"))
